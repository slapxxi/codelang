...
function ErrorTooltipProvider({ delayDuration = 0, ...props }: React.ComponentProps<typeof TooltipPrimitive.Provider>) {
  return <TooltipPrimitive.Provider data-slot="tooltip-provider" delayDuration={delayDuration} {...props} />;
}

function ErrorTooltip({ ...props }: React.ComponentProps<typeof TooltipPrimitive.Root>) {
  return (
...
function ErrorTooltipTrigger({ ...props }: React.ComponentProps<typeof TooltipPrimitive.Trigger>) {
...
export { ErrorTooltip, ErrorTooltipTrigger, ErrorTooltipContent, ErrorTooltipProvider };
